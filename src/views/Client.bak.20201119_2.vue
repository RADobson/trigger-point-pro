...
<div class="row">
    <label class="toggle-control">
      <input type="checkbox" checked="unchecked" @change="toggleSex(item.id)" />
...
export default {
   ...
   /*#########################################################################
     ################# DRAG-N-DROP DB SYNC NOT WORKING #######################
     #########################################################################
